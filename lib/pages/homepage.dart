      ...
      appBar: AppBar(
          ...
          child: Form(
            ...
            children: <Widget>[
               ...
               TextFormField(
                decoration: InputDecoration(labelText: "Apellidos"),onSaved:(value){
                  lastNameValue = value!;
                } ,validator: (value){
                  if (value!.isEmpty) {
              ...
              TextFormField(
                decoration: InputDecoration(labelText: "Profesion o Rol"),onSaved:(value){
                  profesionRol = value!;
                } ,validator: (value){
                  if (value!.isEmpty) {
              ...
              DropdownButtonFormField(value: documentoSelect,
              icon: const Icon(Icons.arrow_drop_down_circle,color:Colors.deepPurple,),
              dropdownColor: Colors.deepPurple.shade50,
              decoration: InputDecoration(
              labelText: "Tipo de documento",prefixIcon: Icon(
              ...
              onSaved: (documentoSelect){
               ...
               TextFormField(
                decoration: InputDecoration(labelText: "Numero Documento"),onSaved:(value){
                  documentoId = value! ;
                } ,validator: (value){
                  if (value!.isEmpty) {
  ...
  void _showSeconPage(BuildContext context){
    if (formKey.currentState!.validate()) {
      formKey.currentState!.save();
        Navigator.of(context).pushNamed("/segunda",arguments: SeconsPageArguments
    (name: this.nameValue,
    lastName: this.lastNameValue,
    profesionRol:this.profesionRol,
     documentoId:this.documentoId, tipoDocumet: this.tipoDocument,
